...
export default function MentorPage() {
  ...
  const PRESET_SKILLS = [
    "Python", "JavaScript", "Java", "C++", "HTML", "CSS", "SQL", "C#", "React",
    "Tailwind CSS", "Node.js", "Express.js", "Next.js", "Flask", "Django", "Bootstrap",
    "MongoDB", "PostgreSQL", "MySQL", "Firebase", "Supabase", "Git / Version Control",
    "REST APIs", "Web Development", "Mobile Development", "UI/UX Design",
    "Data Structures & Algorithms", "Object-Oriented Programming", "Resume Building",
    "Mock Interviews", "System Design", "Frontend", "Backend Development", "Full Stack Development",
  ];

  const PRESET_INTERESTS = [
    "Software Engineering", "Product Management", "Program Management", "Project Management",
    "Consulting", "Cybersecurity", "Startups & Entrepreneurship", "Data Science & Analytics",
    "Anime & Gaming", "Stocks & Investing", "Content Creation", "Sports & Fitness",
    "Music & Performing Arts", "Leadership & Public Speaking", "Diversity in Tech",
  ];
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      const { data, error } = await supabase
        .from("users")
        .select("id, name, year, bio, skills, interests, ai_interest, experience_years, preferred_meeting, points, profile_picture")
  ...
  useEffect(() => {
    ...
    const fetchMentors = async () => {
      ...
      if (error) {
        ...
        const matches = getTopMentorMatches(
          userProfile,
          data,
          PRESET_SKILLS,
          PRESET_INTERESTS,
        ...
        {topMentors.map(({ mentor, score }) => (
          ...
          >
            <div className="w-24 h-24 rounded-full overflow-hidden shadow-md border-4 border-blue-200 mb-4">
              <img
                src={mentor.profile_picture || "https://picsum.photos/200"}
                alt={mentor.name}
            ...
            <div className="w-full mb-2">
              ...
              <div className="text-sm mt-1 text-blue-700 font-semibold">
