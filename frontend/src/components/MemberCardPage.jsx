					...
					<div className="flex flex-col md:flex-row items-center md:items-start gap-8">
						...
						<div className="flex-1 text-center md:text-left">
							...
							<div className="flex flex-col sm:flex-row gap-4 mb-6">
								<div className="text-2xl font-bold text-indigo-600">{member.points ?? 0} points</div>

								{hasLinkedIn && (
									<a href={member.linked_in_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-indigo-500 hover:bg-indigo-600 text-white rounded-full font-medium transition-colors duration-200">
